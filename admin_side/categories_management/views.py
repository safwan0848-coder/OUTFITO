...
def add_category(request):
    ...
    # ----------------------------
    request.session['last_admin_page'] = 'add_category'
...
def category_list(request):
    ...
    # Session (optional, safe)
    # ----------------------------
    request.session['last_admin_page'] = 'category_list'
    ...
    categories = Category.objects.filter(
        ...
        product_count=Count('products')   # keep same (no change)
    )
...
def edit_category(request, id):
    ...
    # Session (optional, safe)
    # ----------------------------
    request.session['last_admin_page'] = 'edit_category'
